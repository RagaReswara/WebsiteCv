...
export const projects: Project[] = [
  ...
  },
  {
    ...
    alt: 'Persiapan material batu kali dan pengerjaan pondasi talud',
...
export const galleryData: Record<Exclude<Category, 'All'>, { title: string; description: string; images: { src: string; alt: string; section?: string }[]; progressGroups?: ProgressGroup[] }> = {
  ...
  'Talud': {
    ...
    images: [
      { src: '/images/talud-2.jpg', alt: 'Persiapan material batu kali dan pengerjaan pondasi talud', section: 'Konstruksi Talud Penahan Tanah' },
      ...
      { src: '/images/talud-4.jpg', alt: 'Pembangunan talud saluran air panjang dengan batu kali', section: 'Konstruksi Talud Penahan Tanah' },
      ...
      { src: '/images/irigasi-3.jpg', alt: 'Saluran irigasi pertanian dengan dinding beton pracetak rapi', section: 'Konstruksi Saluran Irigasi' },
      { src: '/images/irigasi-4.jpg', alt: 'Pemasangan buis beton dan pengerjaan drainase irigasi desa', section: 'Konstruksi Saluran Irigasi' },
